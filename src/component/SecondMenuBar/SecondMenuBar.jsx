...
function SecondMenuBar() {
  return (
      <div className="bg-white z-10 m-0 mt-0 h-100vh flex flex-col gap-8 justify-around absolute shadow-2xl px-8 py-14 top-0 right-0 left-0 md:h-auto md:mx-16 lg:w-[50%] lg:ml-[50%] ">
        <header className="">
          <button
            type="button"
